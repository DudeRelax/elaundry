...
$paket = ambildata($conn,'SELECT id_paket, nama_paket FROM paket');
...
if(isset($_POST['btn-simpan'])){   
  ...
  $query = "INSERT INTO transaksi (kode_invoice,member_id,tgl,batas_waktu,status,status_bayar,user_id) 
  VALUES ('$kode_invoice','$member_id','$tgl_sekarang','$batas_waktu','Baru','Belum','$user_id')";
