...
require 'kasir.php';
require 'header.php';
$penghasilan = ambilsatubaris($conn,"SELECT SUM(total_harga) AS total FROM detail_transaksi INNER JOIN transaksi ON transaksi.id_transaksi = detail_transaksi.transaksi_id WHERE status_bayar = 'Dibayar' AND YEAR(tgl_pembayaran) = YEAR(NOW())");
  ...
  <div class="row">
      <div class="col-xs-12 col-md-12 col-lg-12 no-padding">
        <div class="panel panel-orange panel-widget border-right">
          <div class="row no-padding"><i class="fa fa-xl fa-money-bill-wave color-teal"></i>
            <div class="large"><?= htmlspecialchars($penghasilan['total'] == null ? 0 : 'Rp. '.$penghasilan['total']); ?></div>
            <div class="text-muted">Penghasilan</div>
          </div>
        </div>
      </div>
    </div><!--/.row-->
    ...
    <div class="col-md-12 col-lg-12 col-sm-12">
      <div class="panel panel-container">
        <div style="padding: 0 30px 30px 30px;">
          <h3 style="padding: 0 0 20px 0;">Laporan Penghasilan</h3>
